...
class ConfigManager:
    ...
    def __init__(self, config_dir: str = None):
        if config_dir is None:
            config_dir = os.path.join(os.path.dirname(__file__), "..", "config", "product_types")
    ...
    def _load_builtin_configs(self):
        ...
        pattern_config = ProductTypeConfig(
            ...
            etsy_settings={
                ...
                "default_tags": ["seamless pattern", "digital pattern", "printable", "commercial use"]
            },
            ai_prompts={
        ...
        clipart_config = ProductTypeConfig(
            ...
            etsy_settings={
                "category": "Digital",
                "subcategory": "Clipart",
                "default_tags": ["clipart", "digital clipart", "png", "transparent", "commercial use"]
            },
            ai_prompts={
    ...
    def save_config_to_yaml(self, product_type: str, filename: str = None):
        ...
        if not HAS_YAML:
            raise RuntimeError("PyYAML is required to save YAML configurations. Install with: pip install PyYAML")
